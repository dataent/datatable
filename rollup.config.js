...
const devIIFE = merge(baseJS, {
    output: {
        file: 'dist/dataent-datatable.js',
        format: 'iife',
        name: 'DataTable'
    }
});
...
const devCjs = merge(baseJS, {
    output: {
        file: 'dist/dataent-datatable.cjs.js',
        format: 'cjs'
    }
});
...
const devCSS = merge(baseCSS, {
    output: {
        file: 'dist/dataent-datatable.css',
        format: 'cjs'
    }
});
...
const prodIIFE = merge(devIIFE, {
    output: {
        file: 'dist/dataent-datatable.min.js'
    },
    plugins: [
        uglify()
    ]
...
const prodCSS = merge(devCSS, {
    output: {
        file: 'dist/dataent-datatable.min.css'
    }
});
